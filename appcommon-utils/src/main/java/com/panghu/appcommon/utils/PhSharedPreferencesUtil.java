...
/**
 * PhSharedPreferencesUtil
 *
 *
 * @desc SharedPreferences操作
 * @autor lijiangping
 * @wechat ljphhj
 * @email lijiangping.zz@gmail.com
 *
 **/
public class PhSharedPreferencesUtil {
    ...
    public static boolean put(String name, String key, Object value) {
        if (PhStringUtil.isEmpty(key) || null == value) {
    ...
    public static boolean putAll(String name, String key, List<?> list) {
        if (PhStringUtil.isEmpty(key) || PhArrayUtil.isEmpty(list)) {
